...
impl W {
    #[doc = "Bit 0 - Channel use burst set"]
    #[inline(always)]
    pub fn ch0(&mut self) -> Ch0W<'_, ChnlUseburstSetSpec> {
        Ch0W::new(self, 0)
    }
    #[doc = "Bit 1 - Channel use burst set"]
    #[inline(always)]
    pub fn ch1(&mut self) -> Ch1W<'_, ChnlUseburstSetSpec> {
        Ch1W::new(self, 1)
    }
    #[doc = "Bit 2 - Channel use burst set"]
    #[inline(always)]
    pub fn ch2(&mut self) -> Ch2W<'_, ChnlUseburstSetSpec> {
        Ch2W::new(self, 2)
    }
    #[doc = "Bit 3 - Channel use burst set"]
    #[inline(always)]
    pub fn ch3(&mut self) -> Ch3W<'_, ChnlUseburstSetSpec> {
        Ch3W::new(self, 3)
    }
}
