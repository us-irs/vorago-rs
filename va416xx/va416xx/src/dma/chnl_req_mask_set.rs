...
impl W {
    #[doc = "Bit 0 - Channel Request Mask set"]
    #[inline(always)]
    pub fn ch0(&mut self) -> Ch0W<'_, ChnlReqMaskSetSpec> {
        Ch0W::new(self, 0)
    }
    #[doc = "Bit 1 - Channel Request Mask set"]
    #[inline(always)]
    pub fn ch1(&mut self) -> Ch1W<'_, ChnlReqMaskSetSpec> {
        Ch1W::new(self, 1)
    }
    #[doc = "Bit 2 - Channel Request Mask set"]
    #[inline(always)]
    pub fn ch2(&mut self) -> Ch2W<'_, ChnlReqMaskSetSpec> {
        Ch2W::new(self, 2)
    }
    #[doc = "Bit 3 - Channel Request Mask set"]
    #[inline(always)]
    pub fn ch3(&mut self) -> Ch3W<'_, ChnlReqMaskSetSpec> {
        Ch3W::new(self, 3)
    }
}
