...
pub type R = crate::R<RamTrapSynd1Spec>;
#[doc = "Register `RAM_TRAP_SYND1` writer"]
pub type W = crate::W<RamTrapSynd1Spec>;
...
impl W {
    #[doc = "Bits 0:5 - 6-bit syndrome value for bits 15-0"]
    #[inline(always)]
    pub fn ram_synd_7_0(&mut self) -> RamSynd7_0W<'_, RamTrapSynd1Spec> {
        RamSynd7_0W::new(self, 0)
    }
    #[doc = "Bits 6:11 - 6-bit syndrome value for bits 31-16"]
    #[inline(always)]
    pub fn ram_synd_31_16(&mut self) -> RamSynd31_16W<'_, RamTrapSynd1Spec> {
...
pub struct RamTrapSynd1Spec;
impl crate::RegisterSpec for RamTrapSynd1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ram_trap_synd1::R`](R) reader structure"]
impl crate::Readable for RamTrapSynd1Spec {}
#[doc = "`write(|w| ..)` method takes [`ram_trap_synd1::W`](W) writer structure"]
impl crate::Writable for RamTrapSynd1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets RAM_TRAP_SYND1 to value 0"]
impl crate::Resettable for RamTrapSynd1Spec {}
