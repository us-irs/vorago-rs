#[doc = "Register `ID1_CMB9` reader"]
pub type R = crate::R<Id1Cmb9Spec>;
#[doc = "Register `ID1_CMB9` writer"]
pub type W = crate::W<Id1Cmb9Spec>;
...
#[doc = "CAN Frame Identifier Word 1\n\nYou can [`read`](crate::Reg::read) this register and get [`id1_cmb9::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`id1_cmb9::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Id1Cmb9Spec;
impl crate::RegisterSpec for Id1Cmb9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`id1_cmb9::R`](R) reader structure"]
impl crate::Readable for Id1Cmb9Spec {}
